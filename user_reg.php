...
<main class="form-signin w-50 m-auto">
  <form id="send_phone">
    ...
    <h class="h3 mb-3 fw-normal">Данные профиля</h>
    <div class="mb-3">
      <input type="text" name="name" class="form-control" id="exampleFormControlInput1" placeholder="имя">
    </div>
    <div class="mb-3">
      <input type="text" name="lname" class="form-control" id="exampleFormControlInput1" placeholder="фамилия">
    </div>
    <div class="mb-3">
      <input type="password" name="password" class="form-control" id="exampleFormControlInput1" placeholder="пароль">
    </div>
    <div class="mb-3">
      <input type="password" name="password_ver" class="form-control" id="exampleFormControlInput1" placeholder="повтор пароля">
    </div>
...
<script type="text/javascript">
     ...
     $(function() {
         $('#send_phone').on('submit', function () {
             ...
             $.ajax({
                 type: 'POST',
                 url: '/actions/end_reg.php',
                 data: $('#send_phone').serialize(),
                 dataType: 'json',
                 success: function (result) {
                     if (result.response) {
                             window.location.href = 'https://ivanovpps.full-data.ru/lk.php';
                     } else {
