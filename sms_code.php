...
<main class="form-signin w-100 m-auto">
  <form id="send_code">
    <h1 class="h1 mb-3 fw-normal">Код из СМС</h1>
...
<div class="input-group pb-3">
  ...
  <input type="number" min="0" max="9" name="q4" class="form-control">
    ...
    <button class="w-50 btn btn-lg btn-primary" id="btn_send_code" type="submit">Отправить</button
  </form>
</main>
...
<script type="text/javascript">
     ...
     $(function() {
         $('#send_code').on('submit', function () {
             event.preventDefault();
             $("#btn_send_code").attr('disabled', 'disabled');
             var type = $("#btn_send_code").val();
             $.ajax({
                 type: 'POST',
                 url: '/actions/sms_code.php',
